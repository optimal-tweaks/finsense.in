  ...
  firebase.database().ref('blogs/').once('value').then(function (snapshot) {
    ...
    for (let [key, value] of Object.entries(data)) {
      ...
      posts_div.innerHTML = "<div class='col-sm-4 mt-2 mb-1'> " +
        ...
        "<a href='https://us-central1-finsense-wealth-minimal.cloudfunctions.net/app/post/" + key + "'>" +
        "<img src='" + value.imageURL + "' style='height:200px;'> </a>" +
        "<div class='card-body'><a href='https://us-central1-finsense-wealth-minimal.cloudfunctions.net/app/post/" + key + "'><h4 class='card-title'>" + headSub + "</h4>" +
